...
observeEvent(input$Verif_Tot_Next, {
  ...
  else if(input$MedExpOutTot=="Oui") shinyalert("Supprimez les médiateurs", HTML("Pour un effet total de l'exposition sur l'outcome il n'est pas nécessaire de faire apparaître des médiateurs sur votre DAG. Vous ne devez pas les inclure dans votre analyse car ils biaseraient les résultats, nous vous conseillons donc de les supprimer de votre DAG pour la suite. \n \n Pour passer à la suite cochez 'Non'"))
