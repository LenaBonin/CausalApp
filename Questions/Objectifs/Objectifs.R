...
div(class = 'container',
    ...
    p("(Les variables proposées dans les deux phrases suivantes ne sont que des exemples, et pourront ensuite être remplacées par vos propres variables)"),
        radioButtons("question1", "Quel est l'effet de la classe sociale sur la mortalité ? ",
                     choices = c("Oui", "Non"),
                     selected = values$question1),
        br(),
    
    
    radioButtons("question2", "Quel est le rôle du tabac comme intermédiaire entre la classe sociale et la mortalité ?", 
                 choices = c("Oui", "Non"), 
